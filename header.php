		...
		<?php if(is_front_page() ):?>
			<div class="container big-menu">
			  <div class="row alt-menu justify-content-md-center">
			    <div class="alt-logo-background"><div class="col-md-4 alt-logo"><img src="https://altlab.vcu.edu/wp-content/themes/alt_lab_rebirth/imgs/altlab_logo_blackgold.svg" style="height:240px;"></div></div>
