<?php
/**
 * Single self-paced course partial template.
 *
 * @package understrap
 */
			...
			<div class="course-card">
				<div class="card-body">
					...
					<div class="faculty-bio-text">
						<?php echo acf_fetch_course_description();?>
					</div>
					<div class="workshop-request self-course-url">
						<a href="<?php echo acf_fetch_course_url();?>" class="btn btn-alt">Register for '<?php the_title();?>'</a>
					</div>
				</div>
			</div>
